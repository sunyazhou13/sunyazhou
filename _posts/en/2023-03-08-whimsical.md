...
In many development projects, technical design is often done for modules, using various diagramming tools. I recently discovered a great online design tool from abroad:
...
Collecting some tools from the development process to help improve work efficiency.
