...
At year's end, time to hand in my homework. This year, as an unemployed drifter, I wasted quite a bit of time. After living in the Ice City for a year, I once again returned to the base where I used to fight — Beijing, the capital. Don't ask why — `life forced me to`.

This year has been rough. Family members fell ill, my grandmother passed away, work was unstable, the pandemic became normalized... almost no good news. At the beginning of the year, the pandemic broke out, causing a severe lockdown during the Chinese New Year. I spent the New Year at my classmate's place.

### Poetry and Distant Horizons

When I left Kuaishou, a colleague said this was Brother Zhou's poetry and distant horizons. Excuse me — haha. Today, Brother Zhou has to pay the price for his poetry and distant horizons.

> Sometimes, a dream not worth being mocked is not worth realizing.
...
"我"：嗯, 我一定会坚持写好!
```
Thankful that I still have colleagues like this.
...
Since the last term of `Golden Hair Trump`, the US pandemic has been out of control, causing the world to stagnate. After his successor `Biden` took office, the pandemic was still not effectively controlled, and at the same time, money was being wildly printed, causing severe USD inflation. This seriously affected the world economy, and ultimately affected my income (everyone's income).
...
From Harbin West Station to Zhalong Nature Reserve, driving on the highway takes about 3 hours and 10 minutes. Tickets are cheap, just a few dozen yuan.

You need to take the ring highway past the Songhua River Service Area, then take the Suiman Expressway toward Daqing. Daqing is huge — almost 2.5 hours of the journey is within Daqing's territory, passing through Zhaodong, Anda, Hongqi Reservoir in Daqing's Ranghulu District, Lindian County in Daqing... before finally arriving at Qiqihar's Zhalong Service Area.

The highway distance is about 300 km. The total cost for the round trip is about 600 RMB, which is more than enough.

> Key reminder: there are lots of mosquitoes, and bring sun protection gear.

#### Reflections After a Year Back Home

I think I need to talk to you all about what I gained or felt after a year back home.

* Experienced the local culture and customs of my hometown
* Many people are living barely above the subsistence line
* No license plate restrictions at home, so I can drive freely
* No rent to pay
* Buying things in my own house without worrying about moving or whether it's convenient
* Poor work environment, less inclusivity
* The cost of living in my hometown isn't much lower than Beijing, but the income is far less
* Medical care is not great, completely different from Beijing
* No last-one-out elimination at home; teachers, civil servants, and government workers are more popular and accepted by the public
* Hometown values academic credentials over ability; master's degrees from Double First-Class universities may get job opportunities. The rest, forget it.

My hometown is a tier-3 city where real estate is the pillar industry. Former heavy industry brands like Hafei are in decline. Government policies are implemented as empty promises. My deepest impression is that most young and middle-aged people in my hometown are in a state of `having lost hope for the future`, barely getting by. Only a small fraction of business owners can prosper and live stably in the city. Everyone else is in a lying-flat state, living day by day. Career planning is out of the question. Let alone building a harmonious society, developing the economy and high-tech industries. The annual population outflow rate is 33%+. These are some micro-level impressions after returning home.

Life must go on. After thinking for a long time and recognizing the reality and environment, I still feel that tier-1 cities are better suited for my career development.
...
Rather than saying I returned to Beijing to fight, it's more like my failed escape from being a Beijing drifter. Regardless, I can accept everyone's comments about me. This shows my career is suited for tier-1 cities. This is something most people cannot escape. The familiar subway, the hurried pedestrians.
...
* Why do interviews ask about algorithms

##### Why is knowing better than not knowing?

Because even if you studied "Algorithms and Data Structures" in college, you more or less use some algorithms in development. I think the hardest part isn't the algorithm itself, but after learning it, applying it — putting it into actual work or engineering to solve real problems. That's the purpose of learning it well. If you don't even understand it, then your colleagues can't be on the same level as you. If they say something and you don't understand, is that good?

##### Different Perspectives for Different People

For example: if in development we need to build a recommendation system based on personal preferences, if you don't understand some mathematical concepts or algorithms, you wouldn't know that a concept called [Euclidean Distance](https://zh.wikipedia.org/wiki/%E6%AC%A7%E5%87%A0%E9%87%8C%E5%BE%97%E8%B7%9D%E7%A6%BB) can help us implement this system. Its formula can help us determine whether some content is close to what we like. Although what we see is a bunch of formulas or incomprehensible algorithm expressions, this is the scientific basis within the scope of algorithms that can help us solve real problems.

**Because we lack the spirit of exploration for unknown knowledge, we always make excuses for not learning cutting-edge technology.**

So I say that different people have different understandings when it comes to learning algorithms.

##### Why Do Interviews Ask About Algorithms?

First, we need to understand why some companies introduce algorithm questions into the interview process. `It's to reshape this technically demanding profession`, `it's to educate practitioners that learning algorithms makes them more valuable`. Because if our professional barrier is low, salaries won't be high. Under a high salary system, practitioners are required to perform at a higher level. To balance the contradiction between technology and professional level, adding algorithm assessment is a scientific measure.
...
This year I took several paid courses and strongly recommend them to everyone. I hope to persist in continuous learning in the future, learning science and technology.

* iOS Development Masterclass — studied 3 times
...
I've been writing year-end summaries for 4 consecutive years now, and I'm continuously filling in my knowledge blind spots. I should keenly grasp the trends in social development, so I can get ahead and learn skills others don't yet have. Then in the future, I won't have to worry about having a place to stand.


## About Gaming

When I was in Beijing, I bought a NEOGEO mini portable game console. After drifting in Beijing for so long, I bought some small gadgets to pass the time and prevent depression. After going back home, it was snatched away by my second sister's daughter `Enhui`. Consider it a gift — sigh.

In middle school, I first encountered the PS one (PlayStation ONE). Back then, I thought Sony was amazing for making gaming products. But even after working for many years, I still couldn't bring myself to buy a PS.
...
After buying it, I can only say I was educated — games are so expensive! But the high price isn't the main point. The key is that one game is 100G+, and the console can only fit 2~3 games at most. To expand storage, a PCIe 4.0 SSD m.2 format solid-state drive costs 2000+ RMB.

If I bought all the accessories, this thing would cost 10k+. I decisively gave up. My financial strength no longer allows me to play PS5.

As for the games, they're still fun:

* Uncharted 4
* Demon's Souls Remake
* The built-in Astro's Playroom is really fun
* It Takes Two

These are all classic games in my opinion.

## About Car Repair

From the cover, you can also see my beat-up car.

It's a long story, but I can only advise you all: don't buy a used car. Let me list the parts I've replaced since I bought this car:

* Brake discs + brake pads, front set
* Continental UC6 (215/55 R16) tires, 4 pieces
* Engine throttle valve
* Alternator belt
* Oil-gas separator
* Carbon canister solenoid valve
* Timing chain + chain guide set
* Turbo boost pipe
* Car battery
* Xenon headlights + Hella 5 lens + Hella 4 ballast set
* 4 spark plugs, replaced twice
* Cabin filter + air filter + oil filter
* Power Flex rear lower control arm polyurethane reinforced bushings
* Trunk liner panel
* Sunroof switch
* Automatic shifter switch set
* MIB 682E head unit
* Flip-logo reverse camera set
* Car floor mats set
* Front left and right window chrome trim strips
* Front control arm aluminum bracket
* Engine bottom resin shield
* Transmission-to-engine mount
* Mud flaps x 4
* Intake port carbon cleaning
* Driver-side rearview mirror assembly, complete
...
* Coolant
* Shock absorbers x 4
* Front shock springs x 2

OK, I'll stop listing here. I can basically repair an EA888 engine now. From a coder to half a Volkswagen mechanic.

> Next step, I plan to install the ELSA software on a beat-up laptop for professional inspection of Volkswagen, Audi, Porsche and other VW-group vehicles.
...
> I want to emphasize one thing: some parts aren't necessarily better from the original manufacturer than from other brands. It depends on what part. For oil filters, as long as you buy from a reputable brand store, it should be fine. It's like buying laptop memory — is it better to buy Lenovo brand memory, or Kingston, Samsung, or SanDisk? Definitely not Lenovo! After all, they're not a dedicated memory manufacturer.

I also stocked up on cabin air filters and engine air filters.

* Cabin filter is inside the car, responsible for filtering air for the AC. The `Mahle` brand is well-known.
* Engine air filter is in the engine bay, responsible for filtering air for the engine intake.
...
> Note: This must be replaced with professional equipment, and after replacement, a 4-wheel alignment is required because the eccentric bolt in the suspension system is being adjusted. This bolt is specifically for adjusting the vehicle's camber angle.
...
The viable solutions to achieve these two goals are:

* Replace the head unit system
