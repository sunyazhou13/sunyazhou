---
layout: post
title: Must-Learn Classics for Those Aspiring to Computer Science Majors
...
* [Brother Bird's Linux Private Kitchen (Basic Study, 3rd Edition)](https://item.jd.com/10064429.html) __Must-learn__  
![](/assets/images/20170429CmputerScienceAndTechnologyClassic/linux.avif) 

*[Linus Torvalds' Blog](https://github.com/torvalds)*
...
I'm studying the iOS direction, so here's a GitHub link to learning resources and a list of masters for me.

* [Chinese iOS/Mac Development Blog List](https://github.com/tangqiaoboy/iOSBlogCN) Yes, once again you're reading right — it's one link, and it shows you how to feed blogs' RSS into the Reeder app  
* [Tang Qiao's Blog](http://blog.devtang.com/2014/07/27/ios-levelup-tips/)
...
#### __Option 1 (Premium & Luxurious)__  
If you have higher requirements, you can buy the [MacBook Pro MF839CH](https://detail.tmall.com/item.htm?spm=a220m.1000858.1000725.9.7HDqEB&id=44131265268&skuId=79231665633&areaId=110100&standard=1&user_id=1669409267&cat_id=2&is_b=1&rn=892765ac3efe1f5cd3df8f0d2eb48f87) `￥7988`
...
#### __Option 2 (Lightweight & Practical)__

If your requirements are average, you can also save money and get a 13.3-inch
[MacBook Air 13.3](https://detail.tmall.com/item.htm?spm=a220m.1000858.1000725.1.7HDqEB&id=530945296812&skuId=3163301283248&areaId=110100&standard=1&user_id=2616970884&cat_id=2&is_b=1&rn=892765ac3efe1f5cd3df8f0d2eb48f87) which is more than enough — one of my coworkers has used his for over 5 years. `￥6488`  
...
#### __Option 3 (On a Shoestring Budget)__

There's an Apple computer that's really cheap, called the [Mac mini](https://www.apple.com/cn/mac-mini/). The Hong Kong version on Taobao is around `￥3300`.

![](/assets/images/20170429CmputerScienceAndTechnologyClassic/macmini.avif)

Note: __*It doesn't come with a monitor, mouse, or keyboard*__ — you'll need to buy a mouse and keyboard yourself. You can buy a second-hand monitor, but as far as I remember, most colleges can provide monitors for students to rent. Monitor + mouse + keyboard, 1500 RMB for new ones is enough.

This fully satisfies study and everyday use; it's just that many people aren't used to it — Apple keyboards and PC keyboards have slightly different key layouts.
But no worries: you can buy a Bluetooth keyboard compatible with Apple for 50 RMB on Taobao.
...
* Raspberry Pi  
  Let me first introduce this — it's the cheapest and smallest computer I've ever seen, and it can run various Linux operating systems. It's just ARM-level, but it's very suitable for students to learn on, because a simple TF card can serve as its hard drive, and keyboard, mouse, Wi-Fi, Bluetooth, and network card are all supported — and it only costs around `￥275`.
  Yes, it's that cheap, and it's imported from the UK. If you get a domestic one, it's only `￥230`  
![](/assets/images/20170429CmputerScienceAndTechnologyClassic/raspberry.avif)

Why is the Raspberry Pi a must-have? Because while learning Linux, you don't want to keep messing around reinstalling different operating systems on your main computer. Actually, it's not strictly necessary, but for learning the shell, I suggest using this — it's more convenient.
It's a must-have for computer-science students who like to tinker, learn technologies, and play with tech.
